        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 lg:relative lg:translate-x-0 group w-64 lg:w-20 lg:hover:w-64 bg-pink-900 text-white flex flex-col transition-all duration-300 ease-in-out z-50 shadow-2xl lg:shadow-none">
            ...
            <nav class="flex-1 px-3 py-6 space-y-2 overflow-y-auto scrollbar-hide">
                ...
                @if(auth()->user()->isAdmin())
                    <!-- Finanzas -->
                    <div class="pt-2 pb-2">
                        <div class="px-4 py-2 text-[10px] font-bold text-pink-400 uppercase tracking-widest lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-300">Finanzas</div>
                        ...
                        <a href="{{ route('admin.expenses.index') }}" class="flex items-center px-4 py-3 rounded hover:bg-pink-800 transition-colors group/link {{ request()->routeIs('admin.expenses.*') ? 'bg-pink-800' : '' }}">
                            ...
                            <span class="ml-4 font-medium lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">Gastos</span>
                        </a>

                        <a href="{{ route('admin.sales.index') }}" class="flex items-center px-4 py-3 rounded hover:bg-pink-800 transition-colors group/link {{ request()->routeIs('admin.sales.*') ? 'bg-pink-800' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                            </svg>
                            <span class="ml-4 font-medium lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">Ventas</span>
                        </a>
                    </div>
                @endif
