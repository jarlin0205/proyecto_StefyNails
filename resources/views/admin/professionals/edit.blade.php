                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <button type="button" onclick="togglePassword('password_edit', 'eyeEdit')"
                                    ...
                                    <svg id="eyeEdit" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="password" name="password_confirmation" id="password_confirm_edit"
                                       class="w-full border-gray-200 rounded-lg focus:ring-pink-500 focus:border-pink-500 transition-all pr-10">
                                <button type="button" onclick="togglePassword('password_confirm_edit', 'eyeConfirmEdit')"
                                    class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 hover:text-pink-600 focus:outline-none" title="Mostrar/ocultar">
                                    <svg id="eyeConfirmEdit" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                    </svg>
                                </button>
