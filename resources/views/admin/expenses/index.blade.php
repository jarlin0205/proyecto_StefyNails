...
<div class="mb-8 p-6 bg-white rounded-xl shadow-sm border border-gray-100">
    <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
        ...
        <div class="flex flex-col sm:flex-row gap-3">
            <a href="{{ route('admin.expenses.export', request()->all()) }}" target="_blank" class="bg-gray-100 text-gray-700 px-6 py-2 rounded-lg font-bold hover:bg-gray-200 transition-colors flex items-center justify-center shadow-sm text-sm uppercase tracking-wider border border-gray-200">
