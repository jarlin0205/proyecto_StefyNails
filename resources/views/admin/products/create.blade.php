    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-pink-500 focus:ring-pink-500" required placeholder="Ej: Crema hidratante barba">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-pink-500 focus:ring-pink-500" placeholder="Detalles del producto...">{{ old('description') }}</textarea>
                ...
                <div class="space-y-4">
                    <div class="grid grid-cols-1 gap-4">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="purchase_price" id="purchase_price" value="{{ old('purchase_price') }}" class="w-full pl-7 border-gray-300 rounded-lg shadow-sm focus:border-pink-500 focus:ring-pink-500" step="0.01" placeholder="Ej: 5000">
                            </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="relative">
                                <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-500">$</span>
                                <input type="number" name="price" id="price" value="{{ old('price') }}" class="w-full pl-7 border-gray-300 rounded-lg shadow-sm focus:border-pink-500 focus:ring-pink-500" required step="0.01">
                            </div>
                            @error('price') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                        </div>
                        <div>
                            <label for="stock" class="block text-sm font-medium text-gray-700 mb-1">Stock Inicial</label>
                            <input type="number" name="stock" id="stock" value="{{ old('stock', 0) }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-pink-500 focus:ring-pink-500" required min="0">
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="image" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition relative overflow-hidden">
                                ...
                                <div id="upload-instruction" class="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    <p class="text-xs text-gray-500">JPG, PNG, GIF (Máx. 2MB)</p>
                                </div>
            ...
            <div class="flex justify-end space-x-3 mt-8 pt-6 border-t">
                ...
                <button type="submit" class="bg-pink-600 text-white px-8 py-2 rounded-lg font-bold shadow hover:bg-pink-700 transition">Guardar Producto</button>
            </div>
        </form>
    </div>
</div>
