...
@section('content')
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 {{ auth()->user()->isAdmin() ? 'xl:grid-cols-5' : 'xl:grid-cols-4' }} gap-6 mb-6">
    @php
    ...
    <div onclick="document.getElementById('modalProducido').classList.remove('hidden')" class="bg-white rounded-lg shadow p-4 border-l-4 border-pink-600 flex items-center min-w-0 cursor-pointer hover:shadow-md transition-shadow">
        ...
        <div class="ml-3 min-w-0 flex-1">
            ...
            <p class="text-lg font-bold text-gray-800 break-words">${{ number_format($totalProduced, 2) }}</p>
        </div>
    </div>
    ...
    <a href="{{ route('admin.appointments.index', ['status' => 'pending']) }}" class="bg-white rounded-lg shadow p-4 border-l-4 border-yellow-500 hover:shadow-md transition-shadow flex items-center min-w-0">
        ...
        <div class="ml-3 min-w-0 flex-1">
            ...
            <p class="text-lg font-bold text-gray-800 break-words">{{ $pendingCount ?? 0 }}</p>
        </div>
    </a>
    ...
    <a href="{{ route('admin.appointments.index', ['status' => 'confirmed']) }}" class="bg-white rounded-lg shadow p-4 border-l-4 border-green-500 hover:shadow-md transition-shadow flex items-center min-w-0">
        ...
        <div class="ml-3 min-w-0 flex-1">
            ...
            <p class="text-lg font-bold text-gray-800 break-words">{{ $confirmedCount ?? 0 }}</p>
        </div>
    </a>
    ...
    <a href="{{ route('admin.appointments.index', ['status' => 'completed']) }}" class="bg-white rounded-lg shadow p-4 border-l-4 border-blue-500 hover:shadow-md transition-shadow flex items-center min-w-0">
        ...
        <div class="ml-3 min-w-0 flex-1">
            ...
            <p class="text-lg font-bold text-gray-800 break-words">{{ $completedCount ?? 0 }}</p>
        </div>
    </a>
    ...
    <div class="bg-white rounded-lg shadow p-4 border-l-4 border-pink-500 hover:shadow-md transition-shadow flex items-center min-w-0">
        ...
        <div class="ml-3 min-w-0 overflow-hidden flex-1">
    ...
    <a href="{{ route('admin.services.index') }}" class="bg-white rounded-lg shadow p-4 border-l-4 border-pink-500 hover:shadow-md transition-shadow flex items-center min-w-0">
        ...
        <div class="ml-3 min-w-0 flex-1">
            ...
            <p class="text-lg font-bold text-gray-800 break-words">{{ $servicesCount ?? 0 }}</p>
        </div>
    </a>
    @endif
...
<div id="modalProducido" class="fixed inset-0 z-[60] overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        <!-- Overlay -->
        <div class="fixed inset-0 bg-gray-900 bg-opacity-75 transition-opacity" aria-hidden="true" onclick="document.getElementById('modalProducido').classList.add('hidden')"></div>

        <!-- Centering hack -->
        <span class="hidden sm:inline-block sm:align-middle sm:h-screen" aria-hidden="true">&#8203;</span>

        <!-- Modal Panel -->
        <div class="relative inline-block align-middle bg-white rounded-xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:max-w-4xl w-full border border-gray-100">
            <div class="bg-white">
                <!-- Header -->
                <div class="bg-pink-600 px-6 py-4 flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-pink-100 text-sm opacity-90">Servicios completados y montos generados</p>
                    </div>
                    <button type="button" onclick="document.getElementById('modalProducido').classList.add('hidden')" class="text-white hover:text-pink-100 transition-colors p-2">
