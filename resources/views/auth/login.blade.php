        ...
        <form action="{{ route('login.post') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <button type="button" onclick="togglePassword('password', 'eyeIcon_password')" class="absolute inset-y-0 right-0 flex items-center px-3 text-gray-400 hover:text-pink-600 focus:outline-none" style="top: -6px;">
